...
% [USAGE]
%       [rgbtex, rgbatex,sinWaveNorm,gHullout] = MakeSineWaveGrating4([s], [phase], [sc], [freq], [contrast], [tilt], [gabor], [color0], [color1], [color2], [saveoutput], [fname], [outfmt])
%
%       [INPUTS]
%
...
%       [OUTPUTS]
%         rgbtex      : Texture in RGB uint8 
%         rgbatex     : Texture in RGBA (alpha channel = gaussian hull for gabor textures. For sinewave textures: defaults to no transparency)
%         sinWaveNorm : Sine wave texture before applying gaussian hull in gabors
%         gHullout    : gaussian hull visualised
